...
export const validateCreateUser = [
  ...
  check('apellido')
    ...
    .notEmpty().withMessage('El apellido es un campo requerido.'),

  check('mail')
    .isEmail().withMessage('El mail debe ser un correo electrónico válido.')
    .notEmpty().withMessage('El mail es un campo requerido.'),
