...
export const valCreateReview = [
  ...
  check("texto_resenia")
    .isString()
    .withMessage("El texto de la reseña debe ser un texto.")
    .optional(),
  ...
  check("calificacion")
    ...
    .notEmpty()
    .withMessage("La calificación es un campo requerido."),
...
export const valUpdateReview = [
  param("id")
    .isInt()
    .withMessage("El ID de la reseña debe ser un número entero."),
  check("id_usuario")
    .isInt()
    .withMessage("El ID del usuario debe ser un número entero.")
    .optional(),
